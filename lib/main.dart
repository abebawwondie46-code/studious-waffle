...
ሙሉውን የ Flutter ኮድ ሳይቀነስ እና አልቆ ሳይቋረጥ ከታች አዘጋጅቼልሃለሁ።

በዚህ ኮድ ውስጥ የተጨመሩት ዋና ዋና ነገሮች፡

Camera Pick / Record Option: በ UploadScreen ውስጥ የካሜራ አዶውን (Camera Icon) ስትነካ ካሜራው ተከፍቶ ቪዲዮ በቀጥታ መቅረጽ እንዲችል አድርጌዋለሁ (ImagePicker().pickVideo(source: ImageSource.camera))።

Change / Replace Video (ምስል/ቪዲዮ ቅያሪ): ቪዲዮው ከተመረጠ በኋላ እንደገና የካሜራ ወይም የጋለሪ አዶውን በመንካት ቪዲዮውን መለወጥ/ቀይሮ አዲስ መምረጥ ትችላለህ።
  ...
  void _uploadVideo() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      final newVid = VideoModel(
        ...
        songTitle: 'Original Audio - my_account',
        likes: 0,
        commentsCount: 0,
        shares: 0,
      );
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Icon(Icons.video_call_rounded, size: 70, color: Color(0xFFFF2A5F)),
                        SizedBox(height: 12),
                        Text(
                        ...
                        SizedBox(height: 6),
                        Text(
                          'Camera recording & Gallery supported',
                    ...
                    Row(
                      ...
                      children: [
                        ElevatedButton.icon(
                          ...
                          label: const Text('Change / Record New'),
      ...
      builder: (context) {
        return SafeArea(
          child: Wrap(
            children: [
              ListTile(
                leading: const Icon(Icons.camera_alt, color: Color(0xFFFF2A5F)),
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            ...
            title: Text('User_${index + 1} liked your video'),
      ...
      body: Column(
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _buildStatColumn('Following', '124'),
              const SizedBox(width: 30),
              _buildStatColumn('Followers', '3.5K'),
              const SizedBox(width: 30),
              _buildStatColumn('Likes', '25.4K'),
            ],
          ),
          const SizedBox(height: 20),
          ...
          Expanded(
            child: userVideos.isEmpty
                ? const Center(child: Text('No videos posted yet', style: TextStyle(color: Colors.white54)))
                : GridView.builder(
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            fit: StackFit.expand,
                            children: [
                              const Icon(Icons.play_circle_fill, color: Colors.white38, size: 30),
                              Positioned(
                                bottom: 4,
                                left: 4,
                                child: Row(
...
class VideoSearchDelegate extends SearchDelegate {
  ...
  Widget buildSuggestions(BuildContext context) {
    return const Center(
      child: Text('Search 5-minute videos, creators, or hashtags'),
    );
  }
}
